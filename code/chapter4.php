...
<div class="row">
    <div class="col-12">
        <h2 style="color: #8cc43d">Decifrar o Indecifrável</h2><br />
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-12 col-md-4">
		<h5 style="color: #8cc43d" align="center">Telegrafo</h5><br />
        <img src="view/static/images/telegrafo1.jpeg" alt="Telegrafo 1" class="img-thumbnail rounded mx-auto d-block" style="max-width: 100%; float:left;"><br />	
    </div>
</div>

<div class="row">
    <div class="col-6 col-lg-7">
        <img src="view/static/images/telegrafo2.jpeg" alt="Telegrafo2" class="img-thumbnail rounded mx-auto d-block" style="max-width: 100%; float:left;"><br />	
		<p>Manuscrito Voynich</p>
    </div><br />
</div>
