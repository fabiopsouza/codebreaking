...
<div class="row">
    <div class="col-12">
        <p class="text-justify">No seculo IX o polimata abu al-kindi, o "filósofo dos árabes" escreveu o manuscrito: "Da elucidação de correspondência codificada", explicando com decodificar um documento pela frequência que algumas algumas letras, iniciando a criptoanálise sistemática.</p>

        <p class="text-justify">Letras que mais aparecem em texto em portugues: <a class="btn btn-sm btn-primary" href="https://www.gta.ufrj.br/grad/06_2/alexandre/criptoanalise.html">Criptoanalise</a></p>
